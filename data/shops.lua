return {
    ...
    PoliceArmoury = {
        ...
        inventory = {
            ...
            { name = 'WEAPON_CARBINERIFLE', price = 16000, metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 3 },
        ...
        targets = {
            { loc = vec3(362.41, -1603.21, 25.45), length = 0.5, width = 3.0, heading = 270.0, minZ = 30.5, maxZ = 32.0, distance = 6 }
        }
    },
    ...
    hutingShop = {
        ...
        inventory = {
            ...
            { name = 'ammo-musket',   price = 100 },
            { name = 'WEAPON_MUSKET', price = 5000, metadata = { registered = true } },
        },
        locations = {
    ...
    VendingMachineEats = {
        ...
        inventory = {
            { name = 'candy',         price = 5 },
            { name = 'chipscheese',   price = 10 },
            { name = 'chipsribs',     price = 11 },
            { name = 'chipssalt',     price = 8 },
            { name = 'chipshabanero', price = 12 },
            { name = 'ramen',         price = 15 },
        },
        model = {
